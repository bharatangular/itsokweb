  ...
  getEsignData(id: any) {
    ...
    this.api.postNewEsign(url, data).subscribe((res: any) => {
      ...
      if (this.esignData.responseStatus == '1') {
       ...
       // this.submitBackUpAfterEsign(this.esignData.docId); /// Backup Log_Create by Submit life Certificate Approvedtls //  
...
getLifeCertifictdetails(){     
  ...
  var url = 'updatelifecertificatedtls';
  var data = 
  {     
...
submitBackUpAfterEsign(docId:any){
