...
@Component({
  selector: 'app-approve-pensioner-list',
  templateUrl: './approve-pensioner-list.component.html',
  styleUrls: ['./approve-pensioner-list.component.scss']
})
export class ApprovePensionerListComponent implements OnInit {

  
  @Output() EmpId = new EventEmitter();
  config:AppConfig=new AppConfig();
  displayedColumns: string[] = ["requestid",'lrNo','employeeCode','name','pensionerId','downloads',"stop bill"];
...
this.listDetails();
  ...
  console.log("data",data);
    ...
    {
      alert("Approved but Pending at E-Sign.")
    }
