...
@Component({
  selector: 'app-view-pension-ess',
  templateUrl: './view-pension-ess.component.html',
  styleUrls: ['./view-pension-ess.component.scss'],
  providers: [
...
export class ViewPensionEssComponent implements OnInit {
